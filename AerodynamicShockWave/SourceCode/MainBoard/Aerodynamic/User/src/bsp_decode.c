            ...
            case eDataField: /*******数据域******/
                ...
                if(rx_count >= device_decode->ucDataLength)
                {
                    ...
                    switch(device)
                    {
					   ...
					   break;
					   case  LEFT_HAND:
					     DWIN_MessageHandle(USART2,device_decode,device_decode->ucDataLength,&(device_decode->ucDataField[0]));	
					   break;
					   case  RIGHT_HAND:
					     DWIN_MessageHandle(USART3,device_decode,device_decode->ucDataLength,&(device_decode->ucDataField[0]));	
					   break;
					   default:break;
				    }
