...
typedef struct{
        u8   ucPowerStateFlag;          //$)A5gT4W4L,1jV>N;
        u8   ucRunStateFlag;            //$)ATKPPW4L,1jV>N;
        u8   ucResetFlag;               //$)AO5M384N;
        u8   ucAppStartupFlag;          //App$)A?*;z1jV>N;
        u8   ucAppRunPauseFlag;         //App$)ATKPPT]M#1jV>N;
        u8   ucAppStateLimitFlag;       //App$)AW4L,O^VF1jV>N;
        u8   ucBluetoothConnectFlag;    //$)A@6Q@A,=SW4L,
        u8   ucBluetoothRunFlag;        //$)A@6Q@TKPP1jV>N;  
		u16  uiFlashMemoryByte[4];     //$)A4f4"WV=Z
		u16  uiMasterAirCylinder;     //$)AVwFx8W
		u16  uiSlaveAirCylinder;      //$)A4SFx8W
        u16  uiFlowAirCylinder;       //$)AAwA?FxQ9 
