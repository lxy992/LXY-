...
void ADC1_Init(void)
{
	...
	ADC_RegularChannelConfig(ADC1, ADC_Channel_11, 1, ADC_SampleTime_239Cycles5 );/*Detect master air cylinder */
}
...
/*******************************************************************************
* Function Name  : ADC_SamplingDataGet
* Description    : ADC é‡‡æ ·æ•°æ®èŽ·å–
* Input          : None 
* Output         : None
* Return         : None
* Author         : sunny
...
void ADC_SamplingDataGet(void)
{
	...
	/**********æ£€æµ‹ä¸»æ°”ç¼¸ç”µåŽ‹å€?***********/
	Detect_MasterAirCylinderVolt(&SystemParams.uiMasterAirCylinder);
    
	/*********æ£€æµ‹å­æ°”ç¼¸ç”µåŽ‹å€?***********/
	Detect_SlaveAirCylinderVolt(&SystemParams.uiSlaveAirCylinder);
	
	/**********æ£€æµ‹æµé‡æ°”åŽ‹å€?***********/
    Detect_FlowAirCylinderVolt(&SystemParams.uiFlowAirCylinder);

	SystemParams.uiNtc1VoltageValue = GET_Voltage(ActualAalue[NTC1_CHANNEL]);
	
	SystemParams.uiNtc2VoltageValue = GET_Voltage(ActualAalue[NTC2_CHANNEL]);
