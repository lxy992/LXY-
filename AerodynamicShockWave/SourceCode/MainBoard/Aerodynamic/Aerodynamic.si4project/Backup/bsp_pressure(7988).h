...
#define  EN_V1_ON()        GPIOB->BSRR=1<<4
#define  EN_V1_OFF()       GPIOB->BRR=1<<4

#define  EN_V2_ON()        GPIOB->BSRR=1<<3
#define  EN_V2_OFF()       GPIOB->BRR=1<<3

#define  MASTER_CYLINDER_LIMIT2_ON()   GPIOA->BSRR=1<<8
#define  MASTER_CYLINDER_LIMIT2_OFF()  GPIOA->BRR=1<<8

#define  MASTER_CYLINDER_LIMIT1_ON()   GPIOA->BSRR=1<<15
#define  MASTER_CYLINDER_LIMIT1_OFF()  GPIOA->BRR=1<<15
