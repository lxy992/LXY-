...
void Key_All_Serve(void)
{
    ...
    switch(keys.closed)
    {
        ...
        case KEY_FREQUP:
            if (GlobalVar.FrequencyValue < FREQUENCY_NUM) GlobalVar.FrequencyValue++;
            else GlobalVar.FrequencyValue = FREQUENCY_NUM;
        ...
        case KEY_FREQDOWN:
            ...
            break;
        case KEY_ENERGYUP:
            if (GlobalVar.EnergyValue < ENERGY_NUM) GlobalVar.EnergyValue++;
            else GlobalVar.EnergyValue = ENERGY_NUM;
